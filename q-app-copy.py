...
if uploaded_file is not None:
    ...
    st.session_state.instructions = st.text_area("Inserisci le istruzioni generali per tutte le domande:")
...
if st.button("Salva risposte su file"):
    if st.session_state.results:
        with open(filename, "w") as file:
            if st.session_state.instructions.strip():
                file.write(f"Istruzioni generali:\n{st.session_state.instructions.strip()}\n\n")
